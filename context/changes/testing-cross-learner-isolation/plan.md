...
- [x] 3.1 Both handler slices pass against local Supabase: `npm run test:integration` — 4230679
- [x] 3.2 Owner-200 controls pass in both files — 4230679
- [x] 3.3 Default suite still green: `npm test` — 4230679
- [x] 3.4 Linting passes: `npm run lint` — 4230679

#### Manual

- [x] 3.5 `vi.mock` factory documents why a real authed client is not the forbidden anti-pattern — 4230679
- [x] 3.6 Non-existent id also yields 404 (uniform non-enumerable response) — 4230679
